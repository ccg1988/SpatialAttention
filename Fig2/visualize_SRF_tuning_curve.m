...
datafile_rates=analyze_rates('M9X',[842 4 ],0,[1,1]); % inhibition everywhere, put in supplementary figure
...
[datafile_SRF, best_location, number_of_peaks, tuning_area, ~,...
    rate_interpolation, srf_hfig] = analyze_srf_beta(datafile_rates, 3 ,1 , 'c'); %'T' for tranform the SRF